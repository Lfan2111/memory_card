...
# daftar pertanyaan
questions = [
    ('The national language of Brazil', 'Portuguese', 'Brazilian', 'Spanish', 'Italian'),
    ('The capital of France', 'Paris', 'London', 'Berlin', 'Madrid'),
    ('2 + 2 = ?', '4', '3', '5', '22')
]

current_q = 0  # index pertanyaan sekarang
